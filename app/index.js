module.exports = 
{
    requestNew : function(io, room, nExpected, _gameType)
    {
        console.log("Setting up game " + room + " for " + nExpected + " player(s)");

        let pAPI = new GameAPI(io, room);
        let pChat = new Chat(pAPI);

        let pGame = require("./game.js").game(pAPI, pChat, _gameType);

        return {
            game: pGame, 
            expectplayers: nExpected, 
            players: [], 
            socketids: {},
            api: pAPI, 
            chat: pChat, 
